...
public class Utility {
    ...
    public static int getIconResourceForWeatherCondition(int weatherId) {
        ...
        String resourceName = String.format("ic_%s", getForecastResourceNameForWeatherCondition(weatherId));
        int resource = -1;
        try {
            resource = com.example.android.sunshine.app.common.R.drawable.class.getField(resourceName).getInt(null);
        } catch (Exception e) {
            Log.e(TAG, "getIconResourceForWeatherCondition: " + e.getLocalizedMessage());
        }
    ...
    @Nullable
    public static String getForecastResourceNameForWeatherCondition(int weatherId) {
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        String resourceName = getForecastResourceNameForWeatherCondition(weatherId);
        if (resourceName != null) {
            return String.format(Locale.US, formatArtUrl, resourceName);
        }
    ...
    public static int getArtResourceForWeatherCondition(int weatherId) {
        ...
        String resourceName = String.format("art_%s", getForecastResourceNameForWeatherCondition(weatherId));
        int resource = -1;
        try {
            resource = R.drawable.class.getField(resourceName).getInt(null);
        } catch (Exception e) {
            Log.e(TAG, "getArtResourceForWeatherCondition: " + e.getLocalizedMessage());
        }
